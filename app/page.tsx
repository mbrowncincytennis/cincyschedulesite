...
export default function Page() {
  ...
  const loadBookings = () => {
    void fetch(`/api/bookings?date=${date}`)
      .then((r) => r.json())
      .then(setBookings)
      .catch(() => setBookings([]));
  };
  ...
  const allEvents = useMemo(() => {
    ...
    arr.sort((a, b) => {
      const at = to24(a["Start Time"] || "");
      const bt = to24(b["Start Time"] || "");
      if (at < bt) return -1;
      if (at > bt) return 1;
          ...
          >
            <button
              ...
              style={{
                padding: "6px 10px",
                border: "none",
                background: mode === "map" ? "#111" : "#fff",
                color: mode === "map" ? "#fff" : "#111",
                cursor: "pointer",
              }}
            >
              Map
            ...
            <button
              ...
              style={{
                padding: "6px 10px",
                border: "none",
                background: mode === "list" ? "#111" : "#fff",
                color: mode === "list" ? "#fff" : "#111",
                cursor: "pointer",
              }}
            >
              List
                ...
                {[0, 1, 3, 5].map((n) => (
                  <span
                    ...
                    style={{
                      ...
                      height: 10,
                      borderRadius: 4,
                      background: colorForCount(n || 0.5),
